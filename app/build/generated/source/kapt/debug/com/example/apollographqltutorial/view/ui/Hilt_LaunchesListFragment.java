...
public abstract class Hilt_LaunchesListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LaunchesListFragment() {
    super();
  }

  Hilt_LaunchesListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LaunchesListFragment_GeneratedInjector) this.generatedComponent()).injectLaunchesListFragment(UnsafeCasts.<LaunchesListFragment>unsafeCast(this));
    }
  }
