...
public abstract class Hilt_LaunchDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LaunchDetailsFragment() {
    super();
  }

  Hilt_LaunchDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LaunchDetailsFragment_GeneratedInjector) this.generatedComponent()).injectLaunchDetailsFragment(UnsafeCasts.<LaunchDetailsFragment>unsafeCast(this));
    }
  }
